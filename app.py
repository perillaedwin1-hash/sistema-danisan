...
("CH-610","CHORIZO SANTA ROSANO X 8 DE 800 G"),
("CH-611","CHORIZO SANTA ROSANO LLANERO X 12"),
...
("COS3-004","COSTILLA CARNUDA CRUDA X 3000 GR"),
("COS3-002","COSTILLA CARNUDA ROJA X 5000 GR"),
("COS-009","COSTILLA AHUMADA X 125 GR"),
("COS2-100","COSTILLA AHUMADA OFIR X 250 GR"),
("COS2-102","COSTILLA OFIR X 350 GR"),
("COS2-103","COSTILLA OFIR X 400 GR"),
("COS2-105","COSTILLA OFIR X 500 GR"),
("COS2-111","COSTILLA OFIR X 3000 GR"),
("COS-030","COSTILLA ESPECIAL X 250 GR"),
("COS-029","COSTILLA ESPECIAL X 350 GR"),
("COS-028","COSTILLA ESPECIAL X 400 GR"),
("COS-027","COSTILLA ESPECIAL X 500 GR"),
("COS4-001","COSTILLA LLANERA X 250 GR"),
("COS4-003","COSTILLA LLANERA X 350 GR"),
("COS4-004","COSTILLA LLANERA X 400 GR"),
("COS4-006","COSTILLA LLANERA X 500 GR"),
("COS-010","COSTILLA AHUMADA RECORTE X 1000 GR"),
("COS-016","COSTILLA AHUMADA TROZO X 250 GR"),
...
("JAM-006","JAMÓN X 3 LBS"),
("JAM-004","JAMÓN X 5 LBS"),
("JAM2-001","JAMÓN OFIR X 250 GR"),
("JAM2-002","JAMÓN OFIR X 500 GR"),
("JAM2-005","JAMÓN OFIR X 3 LB"),
("JAM2-003","JAMÓN OFIR X 5 LB"),
("JAM3-001","JAMÓN LLANERO X 250 GR"),
("JAM3-002","JAMÓN LLANERO X 450 GR"),
("JAM3-003","JAMÓN LLANERO X 5 LB"),
("JAM3-004","JAMÓN LLANERO X 3 LB"),
("SCH-001","SALCHICHA X LB"),
("SCH-002","SALCHICHA X 15"),
("SCH-004","SALCHICHA ESPECIAL X 4"),
("SCH-005","SALCHICHA ESPECIAL X 10"),
("SCH-007","SALCHICHA SUPERPERRO X 15"),
("SCH-022","SALCHICHA PERRERA X 15"),
("SCH-008","SALCHICHA DEL RANCHO X 3"),
("SCH-009","SALCHICHA DEL RANCHO X 5"),
("SCH-011","SALCHICHA DEL RANCHO X 15"),
("SCH-013","SALCHICHA SUIZA X 1000 GR"),
("TOC-001","TOCINETA AHUMADA 125GR"),
("TOC-002","TOCINETA AHUMADA 250GR"),
("TOC-009","TOCINETA AHUMADA 450GR"),
("TOC-003","TOCINETA AHUMADA 500GR"),
("TOC-004","TOCINETA AHUMADA 1000GR"),
("TOC2-002","TOCINETA AHUM OFIR X 250 GR"),
("TOC2-003","TOCINETA AHUM OFIR X 125 GR"),
("TOC2-001","TOCINETA AHUM OFIR X 500 GR"),
("TOC2-006","TOCINETA AHUM OFIR X 900 GR"),
("TOC2-004","TOCINETA AHUM OFIR X 1000 GR"),
("TOC-008","TOCINETA LLANERA X 450 GR"),
("TOC-014","TOCINETA LLANERA X 900 GR"),
